...
<html lang="en">
  <head>
    ...
    <!-- Le styles -->
    <link href="/~hmisite/css/bootstrap.css" rel="stylesheet">
	<link href="/~hmisite/css/era-page.css" rel="stylesheet">
    <link href="/~hmisite/css/bootstrap-responsive.css" rel="stylesheet">
	<link href="/~hmisite/css/jquery-ui-1.8.21.custom.css" />
	<link href="/~hmisite/css/fcal.css" rel="stylesheet">
	<link href="/~hmisite/css/facebox.css" media="screen" rel="stylesheet" type="text/css"/>
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li><a href="/~hmisite">Home</a></li>
              <li><a href="/~hmisite/pages/ladies.php">Ladies of HMI</a></li>
              <li><a href="/~hmisite/pages/application.php">Membership Application</a></li>
			  <li><a href="/~hmisite/pages/newsletter.php">Newsletter</a></li>
			  <li><a href="/~hmisite/pages/directory.php">Directory</a></li>
              <!-- Read about Bootstrap dropdowns at http://twitter.github.com/bootstrap/javascript.html#dropdowns -->
              <li class="active dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Impressions <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="/~hmisite/pages/era/wwii.php">World War Two</a></li>
                  <li><a href="/~hmisite/pages/era/wwi.php">World War One</a></li>
                  <li><a href="/~hmisite/pages/era/civilwar.php">Civil War</a></li>
                  <!--<li class="divider"></li>
                  <li class="nav-header">Nav header</li>-->
                  <li><a href="/~hmisite/pages/era/1812.php">War of 1812</a></li>
                  <li><a href="/~hmisite/pages/era/revwar.php">Rev War</a></li>
				  <li><a href="/~hmisite/pages/era/french&indian.php">French and Indian War</a></li>
                </ul>
              </li>
			  ...
			  <li class="dropdown">
				...
				<? } ?>
                  ...
                  <li><a href="/~hmisite/logout.php">Sign Out</a></li>
                </ul>
              </li>
			  <? } else { ?>
			  <li><a href='/~hmisite/login.php'>Sign In</a></li>
			  <? } ?>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
...
background-image: -webkit-gradient(
	...
	color-stop(0.77, rgb(173,141,113))
        ...
        filter: dropshadow(color=#242424, offx=1, offy=2);">French and Indian War</h2>
				...
				<!--<div class="span2"><img src="/~hmisite/images/resources/28th.png" /></div>-->
			</div>
		</div>
        ...
        box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/~hmisite/pages/era/page_images/rogers.gif" />
					</div>
				</div>
			</div>
        ...
        box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/~hmisite/pages/era/page_images/milice.jpg" />
				</div>
			...
			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/~hmisite/pages/era/page_images/milice2.jpg" />
					<img style="margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);
			
			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/~hmisite/pages/era/page_images/milice3.jpg" />
					<img style="margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);
			
			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/~hmisite/pages/era/page_images/milice4.jpg" />
					<center><img style="margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);
			
			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/~hmisite/pages/era/page_images/milice5.jpg" /></center>
				</div>
    ...
    <script src="/~hmisite/js/jquery.js"></script>
	<script src="/~hmisite/js/jquery.maskedinput-1.3.min.js"></script>
	<script src="/~hmisite/js/facebox.js"></script>
    <script src="/~hmisite/js/bootstrap.js"></script>
	<script type="text/javascript" src="/~hmisite/js/jquery-ui-1.8.21.custom.min.js"></script>
	<script type="text/javascript" src="/~hmisite/js/date-time.js"></script>
	<script type="text/javascript" src="/~hmisite/js/cal.js"></script>
