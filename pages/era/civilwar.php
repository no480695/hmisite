...
<html lang="en">
  ...
  <div id="addPics" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="top: 30%;">
   ...
   <div class="navbar navbar-inverse navbar-fixed-top">
            ...
            <ul class="nav">
              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="/pages/era/civilwar.php">Civil War</a></li>
    ...
    <div class="container">
		<div class="hero-unit" style="background-image: linear-gradient(bottom, rgb(64,95,117) 8%, rgb(75,117,148) 53%, rgb(85,131,166) 100%);
background-image: -o-linear-gradient(bottom, rgb(64,95,117) 8%, rgb(75,117,148) 53%, rgb(85,131,166) 100%);
background-image: -moz-linear-gradient(bottom, rgb(64,95,117) 8%, rgb(75,117,148) 53%, rgb(85,131,166) 100%);
background-image: -webkit-linear-gradient(bottom, rgb(64,95,117) 8%, rgb(75,117,148) 53%, rgb(85,131,166) 100%);
background-image: -ms-linear-gradient(bottom, rgb(64,95,117) 8%, rgb(75,117,148) 53%, rgb(85,131,166) 100%);

background-image: -webkit-gradient(
	linear,
	left bottom,
	left top,
	color-stop(0.08, rgb(64,95,117)),
	color-stop(0.53, rgb(75,117,148)),
	color-stop(1, rgb(85,131,166))
        ...
        filter: dropshadow(color=#242424, offx=1, offy=2);">110th Pa Volunteer Infantry</h1>
					<h2 style="text-shadow: 1px 2px 3px #242424;
        filter: dropshadow(color=#242424, offx=1, offy=2);">Civil War</h2>
				</div>
				<div class="span2"><img src="/pages/era/page_images/old.png" /></div>
			</div>
		</div>
		...
		<ul class="nav nav-tabs" id="myTab">
			...
			<li><a href="#engineers" data-toggle="tab">Engineers</a></li>
		</ul>
			...
			<div class="tab-pane active" id="welcome">
				<div class="row">
					<div class="span7 well">
						...
						<p>Recruiting for the 110th Pa started in the summer of 1861. By 1st of Dec, the troops were transferred to Camp Curtin.  From here the Reg. went on to fight in many famous battles such as: Cedar Mountain, 2nd battle of Bull Run, Fredricksburg, Chancellorsville, Gettys burg, Centreville, The Wilderness, Cold Harbor, and Chickahominy.  After Lee's surrender, they marched to Washington and were mustered out of service on the 28th of June 1865.</p>
						<p>If you are interested in joining the 110th please contact Lt. Eric Hawkins, you can e-mail him at etahawkins@verizon.net   Eric will take the time to answer any questions and help you get started in this impression.</p>
					</div>
					<div class="span4">
						<img style="border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

        box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/lang.jpg" />
					</div>
				</div>
			</div>
			...
			<div class="tab-pane" id="engineers">
				<div class="span4 well">
					<p class="lead">Wrigley's Engineers</p>
					<p>Captain William Wentzien is in command of the Engineer unit. Please contact him at bwentzien@cranmerengineering.com he will be glad to help you out and answer any questions you might have if you are interested in joining this impression.</p>
                    <img style="border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

        box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/tom.jpg" />
				</div>

				<div class="span7">
						<img style="border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

        box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/handcock.jpg" />
				</div>

				<div class="span11 well" style="margin-top:20px;">
					<img style="width:510px;margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/jamestown1.jpg" />
					<img style="width:510px;margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/jamestown2.jpg" />
					<img style="width:510px;margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/jamestown3.jpg" />
					<img style="width:510px;margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/jamestown4.jpg" />
            <img style="width:510px;margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/harrisburg.jpg" />
            <img style="width:510px;margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/harrisburg2.jpg" />
            <img style="width:510px;margin:8px;border-radius:5px;-webkit-box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);

			box-shadow: inset 2px 2px 8px 0px rgba(1, 1, 1, 0.4);" src="/pages/era/page_images/engineers/landis.jpg" />
				</div>
			</div>
